(function(){
  ...
  const details={
    ...
    ai:['I know AI could help me do more, but I do not know where to begin.','AI helps with small tasks but not the work that matters most.','I want AI to understand my work, priorities, and vision well enough to be useful.','I want to move faster without outsourcing my judgment.'],
    voice:['The writing is polished and I do not recognize myself in it.','I want AI to help me create content that still sounds like me.','My team or tools need a clear standard for how I communicate.','I have strong examples but do not know how to turn them into a useful guide.'],
    harvest:['I want one conversation to become content I can use in several places.','The best parts of my calls are not making it into my writing or marketing.','I have more recorded material than I have time to review.','I want to preserve my ideas before deciding where to use them.'],
  ...
  const recommendations={
    ...
    ai:{id:'first-hour',name:'The First Hour',url:'first-hour.html?from=guided-start',reason:'AI can help you accomplish more of your vision when it has enough context to understand the work. The First Hour helps you decide what AI should know, what should remain private, and where it can carry more without replacing your judgment.',question:'What part of your vision could move faster if AI had the context to help?'},
